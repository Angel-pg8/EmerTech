...
import iconoPaso1 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso1-grave.png"
import iconoPaso2 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso2-grave.png"
import iconoPaso3 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso3-grave.png"
import iconoPaso4 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso4-grave.png"
import iconoPaso5 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso5-grave.png"
import iconoPaso6 from "../../assets/Emergencias_graves_iconos/desmayo/Desmayo-paso6-grave.png"
...
const pasos = [
  {
    numero: 1,
    titulo: "Verifica su estado",
    descripcion: "Asegúrate de que esté inconsciente y respira.",
    icono: iconoPaso1,
  },
  {
    numero: 2,
    titulo: "Pide ayuda",
    descripcion: "Llama a emergencias si es necesario.",
    icono: iconoPaso2,
  },
  {
    numero: 3,
    titulo: "Colócalo en posición segura",
    descripcion: "Acuéstalo boca arriba y eleva sus piernas.",
    icono: iconoPaso3,
  },
  {
    numero: 4,
    titulo: "Mantén la vía aérea libre",
    descripcion: "Afloja ropa ajustada y asegúrate de que pueda respirar sin dificultad.",
    icono: iconoPaso4,
  },
  {
    numero: 5,
    titulo: "Quédate a su lado",
    descripcion: "Permanece con la persona hasta que se recupere por completo.",
    icono: iconoPaso5,
  },
  {
    numero: 6,
    titulo: "Cuando se recupere",
    descripcion: "Pregúntale cómo se siente y ofrécele agua. No lo dejes solo.",
    icono: iconoPaso6,
    esAlerta: true,
  },
]

export default function Desmayo() {
  ...
  return (
    <div style={{ fontFamily: "'Segoe UI', sans-serif", backgroundColor: "#f0f4f8", minHeight: "100vh", paddingBottom: 100 }}>
      ...
      <div style={{ position: "relative", height: 220, overflow: "hidden", borderBottomLeftRadius: 24, borderBottomRightRadius: 24 }}>
        <img src={imgDesmayo} alt="Desmayo" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
