...
function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 w-full z-50" style={{ backgroundColor: "#b2ebf2" }}>
      <div className="flex justify-around items-center py-2">

        {/* Inicio */}
        <Link to="/"
          className={`flex flex-col items-center gap-1 py-1 px-4 ${isActive("/") ? "text-[#0d1120]" : "text-[#546e7a]"}`}>
        ...
        {/* Chat Bot */}
        <Link to="/"
          className="flex flex-col items-center gap-1 py-1 px-4 text-[#546e7a]">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
